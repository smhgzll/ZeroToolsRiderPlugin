...
{
    [Action("RegenerateEntityAction", "Regenerate Entity")]
    public class RegenerateEntityAction : IActionWithExecuteRequirement, IExecutableAction
    {
        private AspNetZeroRadTool RadTool { get; }

        public RegenerateEntityAction()
        {
        ...
        public void Execute(IDataContext context, DelegateExecute nextExecute)
        {
            ...
            RadTool.MenuItemCallback(solutionPath, true);
        }
    }
}